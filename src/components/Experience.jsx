...
const Experience = () => {
  ...
  return (
    <>
      ...
      <directionalLight position={[0, 3, 1]} intensity={.1}></directionalLight>

      <group ref={cameraGroup}>
        <Bg />
        <PerspectiveCamera position={[0, 0, 5]} fov={30} makeDefault />
        <group ref={airplane}>
          <Float floatIntensity={1} speed={1.5} rotationIntensity={.5}>
            <Plane
      ...
      <Text  color="white"
          ...
          font={'./fonts/Quicksand-Regular.ttf'}
          >
          How did You behave behave in your Life?
        </Text>
        <Text  color="white"
          anchorX={"left"}
          anchorY="top"
